...
function SocialIcon({ name, size = 16 }) {
  ...
  return Icon ? (
    <Icon size={size} strokeWidth={1.85} aria-hidden="true" />
  ) : (
    ...
    <header className="site-header site-header-2tier">
      ...
      <div className="header-top-tier shell">
        <a
          className="brand"
          href="#home"
          aria-label="Utsav Vachhani — back to home"
          ...
          <div className="mobile-socials">
            {SOCIALS.map((s) => (
              <a
                ...
                aria-label={s.label}
              >
                <SocialIcon name={s.label} size={19} />
              </a>
            ))}
          </div>
        </nav>
    ...
    <section id="home" className="hero section-anchor">
      ...
      <div className="shell hero-grid">
        <Reveal className="hero-copy">
          <div className="availability">
            <span className="status-light" /> {PERSONAL_INFO.status}
          </div>
          <p className="eyebrow hero-eyebrow">
            <span className="accent-line" /> HELLO, WORLD. I'M UTSAV.
          </p>
          <motion.h1
          ...
          >
            ...
            <motion.span
              className="headline-line headline-outline"
              variants={lineVariants}
              transition={{ duration: 0.66 }}
            >
              Full-stack.
            ...
            <motion.span
              className="headline-line headline-highlight"
              variants={lineVariants}
              transition={{ duration: 0.66 }}
            >
              Built with purpose<span className="accent-dot">.</span>
            </motion.span>
          </motion.h1>
          <p className="hero-summary">
            I'm <strong>{PERSONAL_INFO.name}</strong>, a full-stack developer
            turning complex ideas into thoughtful, fast and usable digital
            experiences.
          </p>
          <div className="hero-actions">
            <MagneticLink href="#projects" className="button button-lime">
        ...
        <Reveal className="hero-art" delay={0.15}>
          ...
          <div className="portrait-frame">
            <img
              src={uvPhoto}
              alt="Portrait of Utsav Vachhani"
              fetchPriority="high"
            />
          </div>
          ...
          <div className="floating-chip chip-top">
            <span className="chip-sparkle">✳</span> FRONTEND + BACKEND
          </div>
          <div className="floating-chip chip-bottom">
            <Code2 size={15} /> CRAFTED WITH CODE
          </div>
      ...
      <div className="hero-ticker" aria-label="Specialties">
        <div className="ticker-inner">
          <span>
            FULL-STACK DEVELOPMENT <b>✳</b> REACT & NEXT.JS <b>✳</b> CREATIVE
            INTERFACES <b>✳</b> SCALABLE BACKENDS <b>✳</b> FULL-STACK
            DEVELOPMENT <b>✳</b> REACT & NEXT.JS <b>✳</b> CREATIVE INTERFACES{" "}
            <b>✳</b> SCALABLE BACKENDS <b>✳</b>
          </span>
        </div>
      </div>
    </section>
...
function SectionIntro({
  ...
  return (
    <Reveal className={`section-intro ${dark ? "section-intro-light" : ""}`}>
...
function About() {
  return (
    <section id="about" className="section section-anchor section-light">
      <div className="shell">
        <SectionIntro
          index="01"
          ...
          accent="code."
          description="A builder at heart, constantly exploring the space between engineering and design."
        />
        <div className="about-grid">
          <Reveal className="about-statement">
            <p className="mini-label">[ WHAT I DO ]</p>
            <h3>
              I bring <span>ideas to life</span> through clean code & meaningful
              design.
            </h3>
            <div className="about-stripe">
              <Sparkles size={18} /> KEEPING CURIOSITY AT THE CORE
            </div>
          </Reveal>
          <Reveal className="about-body" delay={0.09}>
        ...
        <div className="focus-section">
          <p className="mini-label">[ CORE COMPETENCIES ]</p>
          <div className="focus-grid">
            {FOCUS_AREAS.map((item, i) => (
              <Reveal className="focus-card" key={item.title} delay={i * 0.045}>
...
function ProjectCard({ project, index, onOpen, featured }) {
  ...
  const move = (event) => {
    ...
    ref.current.style.setProperty(
      "--rx",
      `${((event.clientY - top) / height - 0.5) * -4}deg`,
    );
    ref.current.style.setProperty(
      "--ry",
      `${((event.clientX - left) / width - 0.5) * 4}deg`,
    );
  };
  const reset = () => {
    if (ref.current) {
  ...
  return (
    <Reveal
      className={featured ? "project-reveal featured-reveal" : "project-reveal"}
...
function Projects({ onOpen }) {
  ...
  const sorted = useMemo(
    () =>
      [...ALL_PROJECTS].sort(
        (a, b) =>
          (FEATURE_IDS.includes(b.id) ? 1 : 0) -
          (FEATURE_IDS.includes(a.id) ? 1 : 0),
      ),
    [],
  );
  const filtered = useMemo(
    () =>
      sorted.filter(
        (p) =>
          (filter === "All" || categoryOf(p) === filter) &&
  ...
  const visible =
    showAll || filter !== "All" || search.trim()
      ? filtered
      : filtered.slice(0, 6);
  return (
    <section id="projects" className="section section-anchor section-projects">
      <div className="shell">
        <SectionIntro
          index="02"
          ...
          accent="projects."
          description="A collection of products, explorations and experiments. Select a card to go behind the build."
          dark
        />
        ...
        <div className="projects-grid">
          {visible.map((p, i) => (
            <ProjectCard
              ...
              project={p}
              index={i}
              featured={i < 2 && filter === "All" && !search}
              onOpen={onOpen}
            />
          ))}
        </div>
        ...
        {filtered.length > 6 && filter === "All" && !search.trim() && (
...
function Skills() {
  return (
    <section
      id="skills"
      className="section section-anchor section-light section-skills"
    >
      <div className="shell">
        <SectionIntro
          index="03"
          eyebrow="THE TOOLKIT"
          title="Skills behind the"
          accent="screen."
          description="From the interface you see to the infrastructure underneath, here's what I work with."
        />
        ...
        <div className="skills-layout">
          <Reveal className="skills-callout">
            <div className="skills-symbol">&lt;/&gt;</div>
            <h3>
              Full-stack thinking.
              <br />
              <em>Front-to-back execution.</em>
            </h3>
            <p>
              Crafting cohesive digital products with thoughtful interfaces,
              APIs and data.
            </p>
...
function Journey() {
  return (
    <section id="journey" className="section section-anchor section-journey">
      <div className="shell">
        <SectionIntro
          index="04"
        ...
        <div className="journey-grid">
          {MILESTONES.map((item, index) => (
            ...
            >
              ...
              <div>
                <p className="journey-date">{item.year}</p>
                <h3>{item.title}</h3>
                <p>{item.description}</p>
                {item.link && !item.link.includes("example.com") && (
                  <a
                    href={item.link}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                    Explore milestone <ArrowUpRight size={15} />
                  </a>
                )}
              </div>
            </Reveal>
...
function Contact() {
  ...
  return (
    <section id="contact" className="section section-anchor section-contact">
      <div className="shell">
        <SectionIntro
          index="05"
          ...
          title="Have an idea?"
          accent="Let's talk."
          description="Tell me what you're working on. I'm always interested in interesting problems and ambitious ideas."
        />
        <div className="contact-grid">
          <Reveal className="contact-left">
            <span className="mini-label">DIRECT LINE</span>
            ...
            <div className="contact-social-row">
              {SOCIALS.map((item) => (
                <a
                  ...
                  title={item.label}
                >
                  <SocialIcon name={item.label} size={20} />
                </a>
              ))}
            </div>
            <p className="contact-location">
              BASED IN SURAT, INDIA <span>↗</span> WORKING WORLDWIDE
            </p>
          </Reveal>
          <Reveal className="contact-form-wrap" delay={0.1}>
            ...
            <form onSubmit={send}>
              ...
              <button type="submit" className="button button-lime form-submit">
                Open email draft <ArrowUpRight size={18} />
              </button>
              <p className="form-note">
                Opens your email app with your message pre-filled. No data is
      ...
      <div className="shell">
        <div className="footer-lead">
          <div className="footer-lead-copy">
            ...
            <p>
              Let's make something <em>matter.</em>
            </p>
          </div>
        ...
        <div className="footer-columns">
          <div className="footer-brand-column">
            ...
            <p>
              {PERSONAL_INFO.role} creating thoughtful web experiences, from the
            ...
            <div className="footer-social-icons">
              {SOCIALS.map((social) => (
                ...
                >
                  <SocialIcon name={social.label} size={19} />
                </a>
              ))}
            </div>
          </div>
          ...
          <div>
            <h3>Areas of work</h3>
            {FOOTER_CAPABILITIES.map((area) => (
              <span className="footer-capability" key={area}>
                {area}
              </span>
            ))}
          </div>
          <div className="footer-contact-column">
            <h3>Get in touch</h3>
            <a className="footer-email" href={`mailto:${PERSONAL_INFO.email}`}>
              {PERSONAL_INFO.email} <ArrowUpRight size={15} />
            </a>
            <span>{PERSONAL_INFO.location}</span>
            <a className="footer-contact-link" href="#contact">
              Open contact section <ArrowRight size={15} />
            </a>
          </div>
        </div>
