...
export const SOCIAL_LINKS = [
  {
    ...
    label: "GitHub",
    textColor:
      "group-hover:text-white hover:text-white hover:drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]",
  ...
  },
  {
    ...
    label: "Instagram",
    textColor:
      "group-hover:text-[#e4405f] hover:text-[#e4405f] hover:drop-shadow-[0_0_10px_rgba(228,64,95,0.7)]",
  ...
  },
  {
    ...
    label: "X (Twitter)",
    textColor:
      "group-hover:text-[#1da1f2] hover:text-[#1da1f2] hover:drop-shadow-[0_0_10px_rgba(29,161,242,0.7)]",
  ...
  },
  {
    ...
    label: "Facebook",
    textColor:
      "group-hover:text-[#1877f2] hover:text-[#1877f2] hover:drop-shadow-[0_0_10px_rgba(24,119,242,0.7)]",
  ...
  },
  {
    ...
    label: "View CV",
    textColor:
      "group-hover:text-[#ef4444] hover:text-[#ef4444] hover:drop-shadow-[0_0_10px_rgba(239,68,68,0.7)]",
  ...
  },
  {
    ...
    label: "LinkedIn",
    textColor:
      "group-hover:text-[#0a66c2] hover:text-[#0a66c2] hover:drop-shadow-[0_0_10px_rgba(10,102,194,0.7)]",
