...
export const PROJECTS = [
  {
    ...
    description:
      "Full-stack annual college fest registration and event management platform built with the MERN stack.",
    image: Converse2k25,
    techStack: [
      "MongoDB",
      "Express.js",
  ...
  },
  {
    ...
    description:
      "Email security awareness platform with automated threat simulations, analytics reports, and user audits.",
    image: cyberShield,
    techStack: [
      "Next.js",
      "Express.js",
  ...
  },
  {
    ...
    description:
      "Headless WhatsApp automation client and webhook server using whatsapp-web.js and WebSockets.",
    image: whatsappweb,
    techStack: [
      "Vite.js",
      "Express.js",
  ...
  },
  {
    ...
    description:
      "Intuitive productivity application for organized daily workflow tracking, priorities, and status updates.",
    image: taskmanger,
    techStack: [
      "React.js",
      "Express.js",
  ...
  },
  {
    ...
    description:
      "Full-stack fest registration portal featuring real-time synchronization with Google Sheets API and Firebase.",
    image: Converse2k24,
    techStack: [
      "React.js",
      "Firebase Auth",
  ...
  },
  {
    ...
    description:
      "Modern financial analytics telemetry dashboard featuring responsive charts, KPI widgets, and fluid micro-animations.",
  ...
  },
  {
    ...
    description:
      "Full-stack MERN social journal for sharing personal milestones, images, and user interactions with JWT auth.",
    image: Memories,
    techStack: [
      "MongoDB",
      "Express.js",
