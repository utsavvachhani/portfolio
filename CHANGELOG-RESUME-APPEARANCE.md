...
- `/resume` restores the original white/olive Resume look regardless of homepage theme.
- `public/resume/resume.html` is the single editable Resume HTML file, including all 15 showcased projects. `/resume` uses this exact file for preview and iframe printing. The included PDF was generated from it at standard A4 sizing.
