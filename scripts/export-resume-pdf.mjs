...
// Fast, reliable renderer when available, tested with the included Resume.
if (run(process.env.WEASYPRINT_PATH || "weasyprint", [source, staged]))
  process.exit(0);
...
console.error(
  "PDF not updated: install WeasyPrint or Chrome, or open public/resume/resume.html in Chrome and use Print > Save as PDF (A4, no headers/footers).",
);
process.exitCode = 1;
